...
if __name__ == "__main__":
	...
	CR_segfl='/nfs/slac/g/ki/ki18/anja/SUBARU/eyes/CRNitschke_output/data_SCIENCE_cosmics/SEGMENTATION_CRN-cosmics_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE,)
	CR_filtfl='/nfs/slac/g/ki/ki18/anja/SUBARU/eyes/CRNitschke_output/data_SCIENCE_cosmics/FILTERED_CRN-cosmics_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE,)
	...
	CRfitsfl.close()
	#get stars images
	star_segfl='/nfs/slac/g/ki/ki18/anja/SUBARU/eyes/CRNitschke_output/data_SCIENCE_stars/SEGMENTATION_CRN-stars_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,flname,)
	...
	fl_original=compare_dir+'BBout_ORIGINAL_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE)
	...
	hdu.header=CRfiltheader
	fl_woblend=compare_dir+'BBout_WOblend_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE)
	...
	hdu.header=CRfiltheader
	fl_erase=compare_dir+'BB_ERASED_'+bthresh1_tag+'_BBCR_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE)
	...
	hdu.header=CRfiltheader
	fl_revised=compare_dir+'BBrevised_'+bthresh1_tag+'_BBCR_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE)
	hdu.writeto(fl_revised,clobber=True)
	files2check.append(fl_revised)
	#files2check.append(compare_dir+'BBrevised_bfrac0pt0100_BBCR_%s_%s.%s_wjb-180.fits' % (OBJECT,FILTER,BASE))
