...
### is now disjunct
###
### $Id: do_Subaru_template_masking.sh,v 1.19 2010-02-02 23:04:24 dapple Exp $
...
cluster="MACS2228+20"  # cluster nickname as in /nfs/slac/g/ki/ki05/anja/SUBARU/SUBARU.list
filters="W-C-RC_2003-07-27"
