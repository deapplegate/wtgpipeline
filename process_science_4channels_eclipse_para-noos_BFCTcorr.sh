#!/bin/bash
set -xv
#adam-does# this script will do the preprocessing steps without the os or BIAS correction, because it's understood that has already been done before the BFcorr was run
#adam-from# copied from process_science_4channels_eclipse_para.sh
#adam-use# use for the preprocessing of scripts that have been BF corrected (and have had the os/BIAS subtraction done before that correction)
