...
for chip in chips_list:
	...
	for fl_diff in fls_diff:
		...
		fl_ending="/u/ki/awright/data/%s/%s/SCIENCE/%s%s.fits" % (cluster,filter,basename_diff,ending)
		...
		flX="/u/ki/awright/data/%s/%s/SCIENCE/%s%s.fits" % (cluster,filter,basename_diff,endingX)
