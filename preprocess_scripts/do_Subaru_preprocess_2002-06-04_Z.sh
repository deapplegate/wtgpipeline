...
### $Id: do_Subaru_preprocess_2002-06-04_Z.sh,v 1.1 2009-01-22 02:48:06 dapple Exp $
...
#./cp_aux_data.sh ${SUBARUDIR} ${run}_${filter} ${SUBARUDIR}/auxiliary/${run}_${filter}/APR_FLATS
#
#
#####################################################################
...
### copy flatfield ###
#if [ -e ${SUBARUDIR}/${run}_${filter}/${FLAT} ]; then
#    cp ${SUBARUDIR}/${run}_${filter}/${FLAT}/ORIGINALS/*.fits ${SUBARUDIR}/${run}_${filter}/${FLAT}_${SET}/ORIGINALS/
#fi
