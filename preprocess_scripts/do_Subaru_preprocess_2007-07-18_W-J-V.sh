...
### $Id: do_Subaru_preprocess_2007-07-18_W-J-V.sh,v 1.1 2009-01-22 02:48:06 dapple Exp $
...
#skyflat set2, domeflat set 4 (its well past set 4)
FLAT=SKYFLAT        # SKYFLAT or DOMEFLAT
SET=SET2            # sets time period of flat to use
SKYBACK=512          # in case of SKYFLAT: size of background mesh for superflat
...
ln -s ${SUBARUDIR}/${INSTRUMENT}_${config}_${filter}_${FLAT}/${SET}/${FLAT}_${SET}*.fits ${SUBARUDIR}/${run}_${filter}/${FLAT}_${SET}
...
./parallel_manager.sh process_sub_images_para.sh ${SUBARUDIR}/${run}_${filter} ${FLAT}_${SET} SCIENCE ${FRINGE}
...
./create_binnedmosaics.sh ${SUBARUDIR}/${run}_${filter} ${SCIENCEDIR}_norm ${SCIENCEDIR} $SKYBACK 8 -32
