...
### $Id: do_Subaru_preprocess_2001-04-21_I.sh,v 1.1 2009-01-22 02:56:48 dapple Exp $
...
#./cp_aux_data.sh ${SUBARUDIR} ${run}_${filter} ${SUBARUDIR}/auxiliary/${run}_${filter}/DOMEFLAT
...
#    mv ${SUBARUDIR}/${run}_${filter}/${FLAT} ${SUBARUDIR}/${run}_${filter}/${FLAT}_${SET}
#fi
