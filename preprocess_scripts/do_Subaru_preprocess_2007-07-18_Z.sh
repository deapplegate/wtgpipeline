...
### $Id: do_Subaru_preprocess_2007-07-18_Z.sh,v 1.1 2009-01-22 02:48:06 dapple Exp $
...
#gabodsid 3120 will try domeflat set 3,4, skyflat 3
FLAT=DOMEFLAT        # SKYFLAT or DOMEFLAT
SET=SET4            # sets time period of flat to use
...
#./cp_aux_data.sh ${SUBARUDIR} ${run}_${filter} ${SUBARUDIR}/${run}_${filter}/SCIENCE/ORIGINALS/RECONSTRUCT/
