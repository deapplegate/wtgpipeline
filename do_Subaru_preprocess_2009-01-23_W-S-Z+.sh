...
### $Id: do_Subaru_preprocess_2009-01-23_W-S-Z+.sh,v 1.1 2010-02-04 19:55:00 anja Exp $
...
# Note: the z-band shows fringing, but we cannot correct for
# it since we don't have a flatfield...
