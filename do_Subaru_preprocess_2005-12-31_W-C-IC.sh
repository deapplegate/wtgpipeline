...
### $Id: do_Subaru_preprocess_2005-12-31_W-C-IC.sh,v 1.1 2010-02-04 19:55:00 anja Exp $
...
./setup_SUBARU.sh ${SUBARUDIR}/${run}_${filter}/SKYFLAT/ORIGINALS
...
#./check_files.sh  ${SUBARUDIR}/${run}_${filter} ${FLAT} "" 15000 30000
#
...
#fi
#ln -s ${SUBARUDIR}/${run}_${filter}/${FLAT}/SUP*[0-9].fits ${SUBARUDIR}/${run}_${filter}/TEST_${FLAT}/
#
...
./create_binnedmosaics.sh ${SUBARUDIR}/${run}_${filter} TEST_${FLAT} TEST_${FLAT} "" 8 -32
