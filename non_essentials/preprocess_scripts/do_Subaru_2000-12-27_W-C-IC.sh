...
### $Id: do_Subaru_2000-12-27_W-C-IC.sh,v 1.1 2010-02-04 19:55:00 anja Exp $
...
### Lessons learned from 2000-12-27_W-C-RC:
### NOTES:
...
### mix runs.
### This makes the construction of a good FLAT very difficult. 

### For R-band, I bypassed the initial flat-field, and used a flatfield
### constructed from the 50 SCIENCE frames.
### Due to the fringing, I cannot do that directly for I-band.
### There are no DOMEFLATs for that month. Hopefully the SKYFLATs
### are not too horrible.

### Errm, the SKYFLATs are no good. There are too few, and thus the
### stars come through.
### New strategy: I need to combine data from several months. I'll
### try first with 2000-12 and 2001-01. I will make a month-dependent
### BIAS subtraction, and then link the OC files from 2001-01 to the
### 2000-12  directory.

### The 8 DOMEFLATs are largely consistent (within 1-2%), but do show
### variations. Oh well, I'll correct the large-scale illumination with
### (smoothed) superflat.

### datasets: 2000-12-27 (57 images)
###           2001-01-20 (43 images)
###           2001-02-20 (69 images)

### Using the 2001-01-20 DOMEFLATs seems to work. I'm only using the
### data from 2000-12. I still see predominantly two patterns...
...
#
#if [ ! -d ${SUBARUDIR}/${run}_${filter}/${FLAT}_FRINGE ]; then
#    mkdir ${SUBARUDIR}/${run}_${filter}/${FLAT}_FRINGE
#fi
#
...
#for ((CHIP=1;CHIP<=${NCHIPS};CHIP++));
#do
#    ln -s ../${FLAT}_norm/${FLAT}_norm_${CHIP}_fringe${SKYBACK}.fits ${FLAT}_FRINGE/${FLAT}_FRINGE_${CHIP}.fits
#done
#cd ${REDDIR}
#
...
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.7 0.84 \
#     BIAS -4 5 \
#     ${FLAT}_FRINGE -0.06 0.03 \
#     SCIENCE_norm 0.6.1.3 \
#     2
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.5 0.57 \
#     BIAS -40 40 \
#     ${FLAT}_FRINGE -0.02 0.02 \
#     SCIENCE_norm 0.6.1.3 \
#     3
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.45 0.57 \
#     BIAS -50 50 \
#     ${FLAT}_FRINGE -0.015 0.02 \
#     SCIENCE_norm 0.6.1.3 \
#     4
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.5 1.03 \
#     BIAS -7 6 \
#     ${FLAT}_FRINGE -0.05 0.05 \
#     SCIENCE_norm 0.6.1.3 \
#     5
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.51 1.02 \
#     BIAS 20 100 \
#     ${FLAT}_FRINGE -0.05 0.05 \
#     SCIENCE_norm 0.6.1.3 \
#     6
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.65 0.8 \
#     BIAS -5 7 \
#     ${FLAT}_FRINGE -0.07 0.02 \
#     SCIENCE_norm 0.6.1.3 \
#     7
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.61 0.72 \
#     BIAS -70 60 \
#     ${FLAT}_FRINGE -0.02 0.02 \
#     SCIENCE_norm 0.6.1.3 \
#     8
...
#./create_global_weights_flags_para.sh \
#     ${SUBARUDIR}/${run}_${filter} \
#     BASE_WEIGHT 0.51 1.08 \
#     BIAS -4 6 \
#     ${FLAT}_FRINGE -0.05 0.06 \
#     SCIENCE_norm 0.6.1.3 \
#     10
#
#
