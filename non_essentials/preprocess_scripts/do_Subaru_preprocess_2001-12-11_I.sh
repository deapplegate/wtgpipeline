...
### $Id: do_Subaru_preprocess_2001-12-11_I.sh,v 1.1 2009-01-22 02:54:27 dapple Exp $
...
#./cp_aux_data.sh ${SUBARUDIR} ${run}_${filter} ${SUBARUDIR}/auxiliary/${run}_${filter}/FLATS
