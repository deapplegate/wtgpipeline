...
#./parallel_manager.sh ./old_cosmics_automask_Zw2089_2007-02-13_W-S-I+.sh ${SUBARUDIR}/${cluster}/${filter}_${run} SCIENCE ${ending} WEIGHTS 2>&1 | tee -a OUT-old_cosmics_automask_${cluster}_${filter}_${run}.log
