...
###
### $Id: do_Subaru_register_MACS1423.sh,v 1.3 2009-07-13 19:42:23 anja Exp $
...
cluster="MACS1423+24"  # cluster nickname as in /nfs/slac/g/ki/ki02/xoc/anja/SUBARU/SUBARU.list
...
if [ ${ASTROMMETHOD} != "SCAMP" ]; then
  ...
  ./create_scamp_distribute_headers.sh ${LINE} ${ASTROMETRYCAT}
