...
randwait = int(random.random()*1)
print 'rand wait hey', randwait
time.sleep(1)
...
if 1:
    if 0: #not trial:
        import commands
        #op = commands.getoutput('/afs/slac/g/ki/software/python/bin/python ' + os.environ['bonn'] + '/calc_tmpsave.py ' + tmpdir) # + ' ' + astrom) 
        ...
        #os.system('/afs/slac/g/ki/software/python/bin/python ' + os.environ['bonn'] + '/calc_tmpsave.py ' + tmpdir) # + ' ' + astrom) 
        os.system('/afs/slac/g/ki/software/python/bin/python ' + os.environ['bonn'] + '/run_photoz.py ' + tmpdir) # + ' ' + astrom) 
