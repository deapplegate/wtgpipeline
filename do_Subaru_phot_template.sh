...
### $Id: do_Subaru_phot_template.sh,v 1.2 2008-09-04 17:56:21 pkelly Exp $
...
### OC STANDARD frames
    ...
    #./parallel_manager.sh ./process_standard_eclipse_para.sh ${SUBARUDIR}/${run}_${filter} BIAS ${FLAT} SCIENCE STANDARD NORESCALE # BIAS AND FLAT 
...
#python retrieve_sdss.py ${SUBARUDIR}/${run}_${filter}/STANDARD/${IMGSDSS}_1OCFS.fits ${IMGSDSS}.cat

echo "./parallel_manager.sh ./create_astrom_std_para.sh ${SUBARUDIR}/${run}_${filter} STANDARD ${ending} default 2 "
