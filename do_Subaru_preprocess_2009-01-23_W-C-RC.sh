...
### $Id: do_Subaru_preprocess_2009-01-23_W-C-RC.sh,v 1.3 2010-02-02 23:04:24 dapple Exp $
...
if [ -d  ${SUBARUDIR}/${run}_${filter}/STANDARD ] && [ ${STANDARDSTARS} -eq 1 ]; then
 ...
 #./parallel_manager.sh 
#./process_standard_4channels_eclipse_para.sh ${SUBARUDIR}/${run}_${filter} BIAS ${FLAT}_norm STANDARD RESCALE 10
