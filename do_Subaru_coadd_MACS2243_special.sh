...
### ASTROMETRIX
###
### $Id: do_Subaru_coadd_MACS2243_special.sh,v 1.3 2009-01-27 00:39:44 dapple Exp $

. SUBARU.ini
. bash_functions.include

SUBARUPIXSCALE=${PIXSCALE}

REDDIR=`pwd`

export SUBARUDIR=/nfs/slac/g/ki/ki05/anja/SUBARU

cluster="MACS2243-09"  # cluster nickname as in /nfs/slac/g/ki/ki02/xoc/anja/SUBARU/SUBARU.list

FILTERS="W-J-V W-C-RC W-C-IC B F450W F606W F814W W-S-Z+"
FILTERS="F450W F606W F814W"
FILTERS="W-J-V"
ASTROM_FILTERS=""
...
#
#### have to fix the PIXSCALE keyword (this is different e.g. for CFH12K)
#
