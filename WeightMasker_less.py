...
if im_shape==(4080, 2000): #config==10_2
	...
	gsp_cut_Zin=13.5 #12.5
		...
		#ZOOM IN CUT: cut with higher gsp and lower grid
		gsp_cut_Zin=14.5
		print '''adam-look: hist_cut_num=40 block_cut=4.0 block_highbias=0.3 grid_cut=7.5 gsp_cut=8.8 grid_cut_Zout=10.0 gsp_cut_Zout=9.0 gsp_cut_Zin=14.5'''
	else:
		raise Exception('something wrong with cut_mode='+cut_mode)
else:
