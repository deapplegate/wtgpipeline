...
def make_database():
    command = 'create table if not exists sdssdust (fieldid mediumint not null, primary key (id), stripe int, field int, run int, rerun int, camcol int, mustart float(12,8), ramin float(12,8), ramax float(12,8), decmin float(12,8), decmax float(12,8), u float(10,4), g float(10,4), r float(10,4), i float(10,4), z float(10,4), ra float(12,8), dec float(12,8), '
