#!/bin/bash
#adam-does# this runs spikefinder without correcting for the guider seeing
#adam-use# used this for MACS0416 W-C-RC, going to see if using the guider seeing works or not for the other filters (CHANGE SOON POSSIBLE)
...
do
    ...
    cat ${TEMPDIR}/spikefinder_$$ |\
  {
	...
	do
		...
		#adam#${P_IC} '%3 %1 %2 * *' ${1}/${2}/diffmask/${BASE}.sp.fits \
		#adam#    ${1}/${2}/diffmask/${BASE}.sa.fits\
		#adam#    ${1}/${2}/diffmask/${BASE}.sh.fits > ${1}/${2}/diffmask/${BASE}.sf.fits
		#adam#rm -f  ${1}/${2}/diffmask/${BASE}.{sp,sa,sh}.fits
