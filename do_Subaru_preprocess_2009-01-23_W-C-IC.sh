...
### $Id: do_Subaru_preprocess_2009-01-23_W-C-IC.sh,v 1.1 2010-02-04 19:55:00 anja Exp $
...
# DOMEFLATs are _very_ consistent with one another.
# SKYFLATs are extremely horrible...
...
### OC SCIENCE frames
#./parallel_manager.sh 
#./prep_science_4channels_para.sh ${SUBARUDIR}/${run}_${filter} BIAS SCIENCE 9
#
