...
###
### $Id: do_Subaru_register_MACS1621.sh,v 1.3 2009-07-13 19:42:23 anja Exp $
...
cluster="MACS1621+38"  # cluster nickname as in /nfs/slac/g/ki/ki02/xoc/anja/SUBARU/SUBARU.list

FILTERS="u W-J-B W-J-V W-C-RC W-C-IC W-S-Z+"
...
# "astrom" or "photom", astrom needs to be run first!
mode="photom"
...
if [ ${ASTROMMETHOD} != "SCAMP" ]; then
  ...
  case ${mode} in
	  ...
	  ;;
      "photom" )
	  ./create_scamp_photom.sh ${LINE} 20000 ${ASTROMETRYCAT}
	  ;;
      * )
	  echo "Specify astrom or photom mode."
	  exit 2
