...
if [ $fit_calibration -eq 1 ]; then
	...
	#2MASS# python fit_locus.py --file /u/ki/awright/data/${cluster}/PHOTOMETRY_W-C-RC_aper/${cluster}.stars.calibrated.cat --columns /u/ki/awright/data/${cluster}/PHOTOMETRY_W-C-RC_aper/${cluster}.qc.columns --extension 1 --bootstrap 5 -l -j --output /u/ki/awright/data//${cluster}/PHOTOMETRY_W-C-RC_aper/BIGMACS_output_2MASS-no_unit_test/ -p /u/ki/awright/data//${cluster}/PHOTOMETRY_W-C-RC_aper/BIGMACS_output_2MASS-no_unit_test/PLOTS 2>&1 | tee -a OUT-fit_locus-2MASS-no_unit_test-bootstrap5.log
	cd $bonn
